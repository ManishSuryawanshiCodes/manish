        ...
        <div className="footer-card glass-card">
          <div className="footer-top">
            <div className="footer-brand">
              <NavLink to="/" className="footer-logo">
                <Zap size={20} className="footer-zap" />
                <span className="logo-text gradient-text">MANish</span>
              </NavLink>
              <p className="footer-tagline">
                Architecting intelligent, liquid-glass digital experiences and AI SaaS platforms.
              </p>
            </div>
          ...
          <div className="footer-bottom">
            <p className="copyright">
              &copy; {currentYear} <strong>Manish Pradeep Suryawanshi</strong>. Crafted with precision & performance.
            </p>
